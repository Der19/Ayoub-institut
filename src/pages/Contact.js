      ...
      <section className="contact-content">
        <div className="contact-messaging">
          ...
          <div className="messaging-buttons">
            <a href="https://wa.me/yournumber" className="messaging-btn whatsapp">
            ...
            <a href="https://t.me/yourusername" className="messaging-btn telegram">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.161c-.169 1.858-.896 6.728-.896 6.728-.896 6.728-1.277 6.728-1.277 6.728-.169.169-.338.338-.677.338-.338 0-.507-.169-.677-.338-.338-.338-1.186-1.186-1.186-1.186l-2.373-1.524-3.39-1.186c-.338-.169-.507-.338-.507-.677 0-.338.169-.507.338-.677l7.458-4.57c.338-.169.677-.169.846.169.169.338.169.677 0 1.015z"/>
              </svg>
              Telegram
            </a>
            <a href="mailto:contactinstitutenjoy@yahoo.com" className="messaging-btn email">
